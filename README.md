...
## Инфа про Правописание комментиев к коммитам:

Все, что нужно знать:
* Обязательно писать в одном стиле.
...
* Пока что я понял, что лучше писать в таком ключе: Добавить в Readme инфу про HEAD
